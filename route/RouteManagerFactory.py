...
class RouteManagerFactory:
    @staticmethod
    def get_routemanager(db_wrapper, dbm, device_id, coords, max_radius, max_coords_within_radius, path_to_include_geofence,
        ...
        if mode == "raids_mitm":
            route_manager = RouteManagerRaids(db_wrapper, dbm, device_id, coords, max_radius, max_coords_within_radius,
            ...
            route_manager = RouteManagerMon(db_wrapper, dbm, device_id, coords, max_radius, max_coords_within_radius,
                                            path_to_include_geofence, path_to_exclude_geofence, routefile,
                                            mode=mode, settings=settings, init=init, name=name, joinqueue=joinqueue
                                            )
        elif mode == "iv_mitm":
            route_manager = RouteManagerIV(db_wrapper, dbm, device_id, coords, 0, 99999999,
                                           path_to_include_geofence, path_to_exclude_geofence, routefile,
            ...
            route_manager = RouteManagerQuests(db_wrapper, dbm, device_id, coords, max_radius, max_coords_within_radius,
                                               path_to_include_geofence, path_to_exclude_geofence, routefile,
