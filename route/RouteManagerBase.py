...
class RouteManagerBase(ABC):
    def __init__(self, db_wrapper: DbWrapperBase, dbm: DataManager, device_id: str, coords: List[Location], max_radius: float,
    ...
    def change_init_mapping(self, name_area: str):
        ...
        self._data_manager.set_data('device', 'patch', update, identifier=self.device_id)
