...
class control(object):
    ...
    def restart_phone(self):
        ...
        if (useadb == 'True' and
            ...
            temp_comm = self._ws_server.get_origin_communicator(origin)
            temp_comm.reboot()
        return redirect(url_for('get_phonescreens'), 302)
    ...
    def upload(self):
        if request.method == 'POST':
            ...
            if file and allowed_file(file.filename):
                ...
                return redirect(url_for('uploaded_files'), 302)
            else:
    ...
    def install_file(self):
        ...
        return redirect(url_for('uploaded_files', origin=str(origin, adb=useadb)), 302)
    ...
    def delete_log_entry(self):
        ...
        return redirect(url_for('install_status'), 302)
