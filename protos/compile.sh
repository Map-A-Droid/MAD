...
for proto in $FILES; do
    ...
    python3 -m grpc_tools.protoc -I="." -I="./mitm_mapper" -I="./stats_handler" -I="./mapping_manager" -I="./shared"  --python_out="$OUTPUT_DIR" --mypy_out="$OUTPUT_DIR" --grpc_python_out="$GRPC_OUT_DIR" "$proto";
    # python3 -m grpc_tools.protoc -I="." -I="./stats_handler" -I="./shared"  --python_out="$OUTPUT_DIR" --grpc_python_out="$GRPC_OUT_DIR" "$proto";
