...
>MAD is compatible with [this Monocle schema](https://raw.githubusercontent.com/whitewillem/PMSF/master/sql/monocle/cleandb.sql) and [this RocketMap fork](https://github.com/cecpk/OSM-Rocketmap). Please use them or change your database accordingly.
