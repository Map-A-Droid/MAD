...
GetPlayerMessage = _reflection.GeneratedProtocolMessageType('GetPlayerMessage', (_message.Message,), {

  'PlayerLocale' : _reflection.GeneratedProtocolMessageType('PlayerLocale', (_message.Message,), {
