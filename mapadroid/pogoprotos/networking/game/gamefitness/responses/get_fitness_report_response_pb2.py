...
# source: pogoprotos/networking/game/gamefitness/responses/get_fitness_report_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/game/gamefitness/responses/get_fitness_report_response.proto',
  package='pogoprotos.networking.game.gamefitness.response',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=b'\nRpogoprotos/networking/game/gamefitness/responses/get_fitness_report_response.proto\x12/pogoprotos.networking.game.gamefitness.response\x1a,pogoprotos/data/fitness/fitness_report.proto\"\x84\x03\n\x18GetFitnessReportResponse\x12`\n\x06status\x18\x01 \x01(\x0e\x32P.pogoprotos.networking.game.gamefitness.response.GetFitnessReportResponse.Status\x12=\n\rdaily_reports\x18\x02 \x03(\x0b\x32&.pogoprotos.data.fitness.FitnessReport\x12>\n\x0eweekly_reports\x18\x03 \x03(\x0b\x32&.pogoprotos.data.fitness.FitnessReport\"\x86\x01\n\x06Status\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x1a\n\x16\x45RROR_PLAYER_NOT_FOUND\x10\x02\x12\x1b\n\x17\x45RROR_RECORDS_NOT_FOUND\x10\x03\x12\x18\n\x14\x45RROR_INVALID_WINDOW\x10\x04\x12\x11\n\rERROR_UNKNOWN\x10\x05\x62\x06proto3'
  ,
...
_GETFITNESSREPORTRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.game.gamefitness.response.GetFitnessReportResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GETFITNESSREPORTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.game.gamefitness.response.GetFitnessReportResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='pogoprotos.networking.game.gamefitness.response.GetFitnessReportResponse.status', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='daily_reports', full_name='pogoprotos.networking.game.gamefitness.response.GetFitnessReportResponse.daily_reports', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weekly_reports', full_name='pogoprotos.networking.game.gamefitness.response.GetFitnessReportResponse.weekly_reports', index=2,
...
GetFitnessReportResponse = _reflection.GeneratedProtocolMessageType('GetFitnessReportResponse', (_message.Message,), {
  ...
  '__module__' : 'pogoprotos.networking.game.gamefitness.responses.get_fitness_report_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.game.gamefitness.response.GetFitnessReportResponse)
  })
