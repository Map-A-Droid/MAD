...
# source: pogoprotos/networking/game/gamepoi/messages/submit_poi_takedown_request_message.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/game/gamepoi/messages/submit_poi_takedown_request_message.proto',
  package='pogoprotos.networking.game.gamepoi.messages',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=b'\nUpogoprotos/networking/game/gamepoi/messages/submit_poi_takedown_request_message.proto\x12+pogoprotos.networking.game.gamepoi.messages\"\xef\x02\n\x1fSubmitPoiTakedownRequestMessage\x12\x0e\n\x06poi_id\x18\x01 \x01(\t\x12u\n\x0einvalid_reason\x18\x02 \x01(\x0e\x32].pogoprotos.networking.game.gamepoi.messages.SubmitPoiTakedownRequestMessage.PoiInvalidReason\"\xc4\x01\n\x10PoiInvalidReason\x12\x1e\n\x1aINVALID_REASON_UNSPECIFIED\x10\x00\x12\x18\n\x14NO_PEDESTRIAN_ACCESS\x10\x01\x12 \n\x1cOBSTRUCTS_EMERGENCY_SERVICES\x10\x02\x12 \n\x1cPRIVATE_RESIDENTIAL_PROPERTY\x10\x03\x12\n\n\x06SCHOOL\x10\x04\x12\x17\n\x13PERMANENTLY_REMOVED\x10\x05\x12\r\n\tDUPLICATE\x10\x06\x62\x06proto3'
)
...
_SUBMITPOITAKEDOWNREQUESTMESSAGE_POIINVALIDREASON = _descriptor.EnumDescriptor(
  ...
  full_name='pogoprotos.networking.game.gamepoi.messages.SubmitPoiTakedownRequestMessage.PoiInvalidReason',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SUBMITPOITAKEDOWNREQUESTMESSAGE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.game.gamepoi.messages.SubmitPoiTakedownRequestMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='poi_id', full_name='pogoprotos.networking.game.gamepoi.messages.SubmitPoiTakedownRequestMessage.poi_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='invalid_reason', full_name='pogoprotos.networking.game.gamepoi.messages.SubmitPoiTakedownRequestMessage.invalid_reason', index=1,
...
SubmitPoiTakedownRequestMessage = _reflection.GeneratedProtocolMessageType('SubmitPoiTakedownRequestMessage', (_message.Message,), {
  ...
  '__module__' : 'pogoprotos.networking.game.gamepoi.messages.submit_poi_takedown_request_message_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.game.gamepoi.messages.SubmitPoiTakedownRequestMessage)
  })
