...
# source: pogoprotos/networking/game/gameiap/responses/purchase_sku_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/game/gameiap/responses/purchase_sku_response.proto',
  package='pogoprotos.networking.game.gameiap.responses',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=b'\nHpogoprotos/networking/game/gameiap/responses/purchase_sku_response.proto\x12,pogoprotos.networking.game.gameiap.responses\x1a+pogoprotos/data/store/currency_update.proto\"\xc2\x02\n\x13PurchaseSkuResponse\x12X\n\x06result\x18\x01 \x01(\x0e\x32H.pogoprotos.networking.game.gameiap.responses.PurchaseSkuResponse.Status\x12\x1c\n\x14\x61\x64\x64\x65\x64_inventory_item\x18\x02 \x03(\x0c\x12>\n\x0f\x63urrency_update\x18\x03 \x03(\x0b\x32%.pogoprotos.data.store.CurrencyUpdate\"s\n\x06Status\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x0b\n\x07\x46\x41ILURE\x10\x02\x12\x13\n\x0f\x42\x41LANCE_TOO_LOW\x10\x03\x12\x15\n\x11SKU_NOT_AVAILABLE\x10\x04\x12\x18\n\x14OVER_INVENTORY_LIMIT\x10\x05\x62\x06proto3'
  ,
...
_PURCHASESKURESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.game.gameiap.responses.PurchaseSkuResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PURCHASESKURESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.game.gameiap.responses.PurchaseSkuResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.game.gameiap.responses.PurchaseSkuResponse.result', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='added_inventory_item', full_name='pogoprotos.networking.game.gameiap.responses.PurchaseSkuResponse.added_inventory_item', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='currency_update', full_name='pogoprotos.networking.game.gameiap.responses.PurchaseSkuResponse.currency_update', index=2,
...
PurchaseSkuResponse = _reflection.GeneratedProtocolMessageType('PurchaseSkuResponse', (_message.Message,), {
  ...
  '__module__' : 'pogoprotos.networking.game.gameiap.responses.purchase_sku_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.game.gameiap.responses.PurchaseSkuResponse)
  })
