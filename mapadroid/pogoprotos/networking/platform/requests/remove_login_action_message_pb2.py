...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\nIpogoprotos/networking/platform/requests/remove_login_action_message.proto\x12\'pogoprotos.networking.platform.requests\x1a(pogoprotos/enums/identity_provider.proto\"s\n\x18RemoveLoginActionMessage\x12=\n\x11identity_provider\x18\x01 \x01(\x0e\x32\".pogoprotos.enums.IdentityProvider\x12\x18\n\x10\x61uth_provider_id\x18\x03 \x01(\tb\x06proto3'
  ,
...
_REMOVELOGINACTIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='auth_provider_id', full_name='pogoprotos.networking.platform.requests.RemoveLoginActionMessage.auth_provider_id', index=1,
