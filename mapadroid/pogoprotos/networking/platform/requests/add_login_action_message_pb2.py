...
_ADDLOGINACTIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='auth_provider_id', full_name='pogoprotos.networking.platform.requests.AddLoginActionMessage.auth_provider_id', index=2,
