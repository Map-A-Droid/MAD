...
class WorkerFactory:
    ...
    async def __get_walker_settings(
        self, origin: str, client_mapping: dict, devicesettings: dict
        ...
        while not pre_check_value(walker_settings, self.__event.get_current_event_id()) and walker_index < len(
            walker_area_array
        ):
            origin_logger.info(
        ...
        walker_configuration = WalkerConfiguration(
            walker_area_name=walker_area_name,
    ...
    async def __prep_settings(self, origin: str) -> Optional[WalkerConfiguration]:
        ...
        walker_configuration: Optional[WalkerConfiguration] = await self.__get_walker_settings(
    ...
    async def get_worker_using_settings(
        self, origin: str, enable_configmode: bool, communicator: AbstractCommunicator
    ...
    def get_worker(
        ...
        # TODO: validate all values
            ...
            WorkerType.RAID_MITM,
            WorkerType.RAID_MITM.value,
        ]:
            return WorkerMITM(
                self.__args,
                dev_id,
