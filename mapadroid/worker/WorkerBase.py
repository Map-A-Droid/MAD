...
from mapadroid.utils.madGlobals import WebsocketWorkerRemovedException, InternalStopWorkerException, \
...
class WorkerBase(ABC):
    def __init__(self, args, id, last_known_state, websocket_handler, mapping_manager: MappingManager,
                 routemanager_name: str, db_wrapper: DbWrapperBase, pogoWindowManager: PogoWindows,
                 NoOcr: bool = True,
                 walker=None):
