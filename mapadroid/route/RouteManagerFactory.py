...
from mapadroid.route import RouteManagerIV
from mapadroid.route import RouteManagerMon
from mapadroid.route import RouteManagerQuests
from mapadroid.route import RouteManagerRaids


class RouteManagerFactory:
    @staticmethod
    def get_routemanager(db_wrapper, dbm, uri, coords, max_radius, max_coords_within_radius,
        ...
        if mode == "raids_mitm":
            route_manager = RouteManagerRaids(db_wrapper, dbm, uri, coords, max_radius,
            ...
            route_manager = RouteManagerMon(db_wrapper, dbm, uri, coords, max_radius,
                                            max_coords_within_radius,
                                            path_to_include_geofence, path_to_exclude_geofence, routefile,
                                            mode=mode, settings=settings, init=init, name=name,
                                            joinqueue=joinqueue
            ...
            route_manager = RouteManagerQuests(db_wrapper, dbm, uri, coords, max_radius,
                                               max_coords_within_radius,
                                               path_to_include_geofence, path_to_exclude_geofence, routefile,
                                               mode=mode, settings=settings, init=init, name=name,
                                               level=level,
