from mapadroid.route import RouteManagerBase
...
class RouteManagerMon(RouteManagerBase):
    ...
    def __init__(self, db_wrapper, dbm, uri, coords, max_radius, max_coords_within_radius,
        ...
        RouteManagerBase.__init__(self, db_wrapper=db_wrapper, dbm=dbm, uri=uri, coords=coords,
