...
class DbSchemaUpdater:
    ...
    column_mods = [
        {"table": "raid", "column": "is_exclusive", "ctype": "tinyint(1) NULL"},
        {"table": "raid", "column": "gender", "ctype": "tinyint(1) NULL"},
        {"table": "raid", "column": "costume", "ctype": "tinyint(1) NULL"},
        {"table": "raid", "column": "evolution", "ctype": "smallint(6) NULL"},
        {"table": "gym", "column": "is_ex_raid_eligible", "ctype": "tinyint(1) NOT NULL DEFAULT 0"},
        {"table": "pokestop", "column": "incident_start", "ctype": "datetime NULL"},
        {"table": "pokestop", "column": "incident_expiration", "ctype": "datetime NULL"},
        {"table": "pokestop", "column": "incident_grunt_type", "ctype": "smallint(1) NULL"},
        {"table": "trs_quest", "column": "quest_pokemon_form_id", "ctype": "smallint(6) NOT NULL DEFAULT 0"},
        {"table": "trs_quest", "column": "quest_pokemon_costume_id", "ctype": "smallint(6) NOT NULL DEFAULT 0"},
    ]
    ...
    def ensure_unversioned_columns_exist(self):
        ...
        try:
            ...
            logger.error(
                "Couldn't create required column {}.{}'", column_mod["table"], column_mod["column"],
            )
            sys.exit(1)
    ...
    def check_create_column(self, column_mod: dict):
        ...
        logger.info(
            "Successfully added column '{}.{}'", column_mod["table"], column_mod["column"],
        )

    def create_column(self, column_mod: dict):
        alter_query = "ALTER TABLE {} " "ADD COLUMN {} {}".format(
            column_mod["table"], column_mod["column"], column_mod["ctype"]
        )
