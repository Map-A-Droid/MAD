...
class RmWrapper(DbWrapperBase):
    ...
    def submit_raids_map_proto(self, origin: str, map_proto: dict, mitm_mapper):
        ...
        logger.debug(
            "RmWrapper::submit_raids_map_proto: Done submitting raids with data received from {}",
            str(origin))
        return True
    ...
    def get_to_be_encountered(self, geofence_helper, min_time_left_seconds,
        ...
        if min_time_left_seconds is None or eligible_mon_ids is None:
            logger.warning(
                "RmWrapper::get_to_be_encountered: Not returning any encounters since no time left or "
    ...
    def __extract_args_single_pokestop(self, stop_data):
        ...
        return stop_data['id'], 1, stop_data['latitude'], stop_data[
            'longitude'], last_modified, lure, now, active_fort_modifier, incident_start, incident_expiration, incident_grunt_type
