...
class Mon(Base):
    ...
    rating_attack = Column(
        String(length=2, collation='utf8mb4_unicode_ci')
    )
    rating_defense = Column(
        String(length=2, collation='utf8mb4_unicode_ci')
    )
...
class Gym(Base):
    ...
    gym_details = relationship(
        'GymDetails',
        uselist=False, backref='gym', lazy='joined', cascade='delete')
...
class GymDetails(Base):
    ...
    name = Column(
        String(length=191, collation='utf8mb4_unicode_ci'), nullable=False
    )
...
class Quest(Base):
    ...
    quest_condition = Column(
        String(length=500, collation='utf8mb4_unicode_ci')
    )
    quest_reward = Column(
        String(length=1000, collation='utf8mb4_unicode_ci')
    )
    quest_template = Column(
        String(length=100, collation='utf8mb4_unicode_ci')
    )
    quest_task = Column(
        String(length=150, collation='utf8mb4_unicode_ci')
    )
    quest_pokemon_form_id = Column(
        SmallInteger, default=0, nullable=False
    )
    quest_pokemon_costume_id = Column(
        SmallInteger, default=0, nullable=False
    )
...
class SpawnPoint(Base):
    ...
    first_detection = Column(
        DateTime, default=datetime.utcnow(), nullable=False
    )
    last_non_scanned = Column(DateTime)
    calc_endminsec = Column(
        String(length=5, collation='utf8mb4_unicode_ci')
    )
