...
class Patch(PatchBase):
    ...
    def _execute(self):
        add_new_index = (
            "ALTER TABLE pokemon " "ADD INDEX pokemon_iv (individual_attack, individual_defense, individual_stamina)"
        )
        drop_old_index = "ALTER TABLE pokemon " "DROP INDEX pokemon_individual_attack"
