...
class Walker(Resource):
    ...
    search_field = "name"
    translations = {"walkername": "name"}
    configuration = {
        "fields": {
            "walkername": {
                "settings": {"type": "text", "require": True, "description": "Name of walker", "expected": str}
            },
            "setup": {
                "settings": {
                    "type": "list",
    ...
    def save(self, force_insert: Optional[bool] = False, ignore_issues: Optional[List[str]] = None,) -> int:
        ...
        core_data = {"walkername": self._data["fields"]["walkername"]}
        ...
        del_data = {"walker_id": self.identifier}
