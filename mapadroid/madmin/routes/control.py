...
from mapadroid.madmin import (auth_required, generate_device_screenshot_path, getBasePath, nocache,
                              allowed_file,
                              uploaded_files)
from mapadroid.utils import ADBConnect
from mapadroid.utils import MappingManager
from mapadroid.utils import ScreenshotType
from mapadroid.utils import (creation_date, generate_phones, image_resize)
from mapadroid.utils import jobType
from mapadroid.utils.logging import logger


class control(object):
    def __init__(self, db_wrapper: DbWrapperBase, args, mapping_manager: MappingManager, websocket, logger,
                 app,
                 deviceUpdater):
    ...
    def get_phonescreens(self):
        ...
        return render_template('phonescreens.html', editform=screens_phone, header="Phonecontrol",
                               title="Phonecontrol")
    ...
    def install_file(self):
        ...
        return redirect(
            getBasePath(request) + '/uploaded_files?origin=' + str(origin) + '&adb=' + str(useadb))
