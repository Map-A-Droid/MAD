...
class MADminConfig(object):
    ...
    def process_element(self, **kwargs):
        ...
        if request.method == "GET":
            included_data = {"base_uri": url_for(base_uri), "identifier": identifier}
            ...
            if identifier is not None:
                ...
                return render_template(html_all, subtab=subtab, **included_data)
    ...
    def settings_areas(self):
        ...
        required_data = {
            ...
            "subtab": "area",
            "required_data": {"monlist": "monivlist", "fences": "geofence"},
            "passthrough": {"config_mode": self._args.config_mode, "ortools_info": ortools_info, "fences": fences},
            "mode_required": True,
        }
    ...
    def settings_devices(self):
        try:
            ...
            pass
        ggl_accounts = PogoAuth.get_avail_accounts(self._data_manager, "google", device_id=identifier)
        ptc_accounts = []
        for account_id, account in PogoAuth.get_avail_accounts(self._data_manager, "ptc", device_id=identifier).items():
            ptc_accounts.append({"text": account["username"], "id": account_id})
        required_data = {
            "identifier": "id",
            "base_uri": "api_device",
            "data_source": "device",
            ...
            "subtab": "device",
            "required_data": {"walkers": "walker", "pools": "devicepool"},
            "passthrough": {
    ...
    def settings_ivlists(self):
        ...
        required_data = {
            ...
            "subtab": "monivlist",
            "passthrough": {"current_mons_list": current_mons_list},
        }
        return self.process_element(**required_data)
    ...
    def settings_pogoauth(self):
        ...
        try:
            ...
            identifier = None
        for dev_id, dev in PogoAuth.get_avail_devices(self._data_manager, auth_id=identifier).items():
        ...
        required_data = {
            ...
            "subtab": "pogoauth",
            "passthrough": {"devices": devices, "devs_google": devs_google, "devs_ptc": devs_ptc},
        }
        return self.process_element(**required_data)
    ...
    def settings_routecalc(self):
        ...
        required_data = {
            ...
            "subtab": "area",
            "section": "routecalc",
            "passthrough": {"areaname": area["name"]},
        }
        return self.process_element(**required_data)
    ...
    def settings_walkers(self):
        required_data = {
            ...
            "subtab": "walker",
            "required_data": {"areas": "area", "walkerarea": "walkerarea"},
        }
        return self.process_element(**required_data)
    ...
    def settings_walker_area(self):
        ...
        return render_template("settings_walkerarea.html", subtab="walker", **mappings)
