...
from mapadroid.madmin.endpoints.routes.autoconfig.AutoconfigPendingSessionEndpoint import \
    AutoconfigPendingSessionEndpoint
...
def register_routes_autoconfig_endpoints(app: web.Application):
    ...
    app.router.add_view('/autoconfig/pending/{session_id}', AutoconfigPendingSessionEndpoint,
                        name='autoconfig_pending_dev')
