...
class APIEntry(object):
    ...
    def __init__(
        self, logger, app, data_manager, mapping_manager, ws_server, config_mode, storage_obj, args,
    ):
        self._logger = logger
        self._app = app
        self._resources = {}
        ...
        for _, module in valid_resources.items():
            tmp = module(
                logger, app, BASE_URI, data_manager, mapping_manager, ws_server, config_mode, storage_obj, args,
            )
