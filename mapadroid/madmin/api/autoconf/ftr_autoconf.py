...
from mapadroid.utils.autoconfig import AutoConfIssue, AutoConfIssueGenerator, PDConfig, RGCConfig, origin_generator
...
class APIAutoConf(AutoConfHandler):
    ...
    def autoconf_delete_session(self, session_id: int):
        del_info = {"session_id": session_id, "instance_id": self.dbc.instance_id}
