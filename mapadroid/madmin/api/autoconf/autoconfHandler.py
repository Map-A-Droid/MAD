...
class AutoConfHandler(apiHandler.APIHandler):
    ...
    def create_routes(self):
        ...
        self._app.route(
            "/api/autoconf/<string:session_id>", methods=["GET", "POST", "DELETE"], endpoint="api_autoconf_status",
        )(self.entrypoint)
        self._app.route("/api/autoconf/rgc", methods=["POST", "DELETE", "GET", "PATCH"], endpoint="api_autoconf_rgc",)(
            self.entrypoint
        )
        self._app.route("/api/autoconf/pd", methods=["POST", "DELETE", "GET", "PATCH"], endpoint="api_autoconf_pd",)(
            self.entrypoint
        )
