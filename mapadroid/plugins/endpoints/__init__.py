...
from mapadroid.plugins.endpoints.DownloadPluginEndpoint import DownloadPluginEndpoint
from mapadroid.plugins.endpoints.UploadPluginEndpoint import UploadPluginEndpoint
